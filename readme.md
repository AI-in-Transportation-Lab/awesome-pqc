# Awesome PQC - Post Quantum Cryptography
...
## Last Updated
September 23, 2026 at 01:55:16 AM UTC
...
- [Authentication Against Insecure Bootstrapping for 5G Networks: Feasibility, Resiliency, and Transitional Solutions in Post-Quantum Era](https://arxiv.org/abs/2510.23457)
- [QuantumShield: Multilayer Fortification for Quantum Federated Learning](https://arxiv.org/abs/2510.22945)
- [A Comparative Study of Hybrid Post-Quantum Cryptographic X.509 Certificate Schemes](https://arxiv.org/abs/2511.00111)
- [Security and Privacy Management of IoT Using Quantum Computing](https://arxiv.org/abs/2511.03538)
- [QMA Complete Quantum-Enhanced Kyber: Provable Security Through CHSH Nonlocality](https://arxiv.org/abs/2511.12318)
- [Extending Quantum-Safe Communications to Real-World Networks: An Adaptive Security Framework](https://arxiv.org/abs/2511.22416)
- [Categorical Framework for Quantum-Resistant Zero-Trust AI Security](https://arxiv.org/abs/2511.21768)
- [Lightweight Unified Sha-3/Shake Architecture with a Fault-Resilient State](https://arxiv.org/abs/2512.03616)
- [Combined Quantum and Post-Quantum Security Performance Under Finite Keys](https://arxiv.org/abs/2512.04429)
- [Quantigence: A Multi-Agent AI Framework for Quantum Security Research](https://arxiv.org/abs/2512.12989)
- [OptHQC: Optimize HQC for High-Performance Post-Quantum Cryptography](https://arxiv.org/abs/2512.12904)
- [Quantum-Resistant Cryptographic Models for Next-Gen Cybersecurity](https://arxiv.org/abs/2512.19005)
- [PQC standards alternatives -- reliable semantically secure key encapsulation mechanism and digital signature protocols using the rank-deficient matrix power function](https://arxiv.org/abs/2601.00332)
- [Post-Quantum Cryptography for Intelligent Transportation Systems: An Implementation-Focused Review](https://arxiv.org/abs/2601.01068)
- [Quantum Secure Biometric Authentication in Decentralised Systems](https://arxiv.org/abs/2601.04852)
- [Simple Power Analysis of Polynomial Multiplication in HQC](https://arxiv.org/abs/2601.07634)
- [Efficient Lattice Hamiltonian Encoding for the Shortest Vector Problem](https://arxiv.org/abs/2307.12047)
- [Towards Quantum-Resistant Trusted Computing: Architectures for Post-Quantum Integrity Verification Techniques](https://arxiv.org/abs/2601.11095)
- [Quantum Encryption Resilience Score (QERS) for MQTT, HTTP, and HTTPS under Post-Quantum Cryptography in Computer, IoT, and IIoT Systems](https://arxiv.org/abs/2601.13423)
- [QERS: Quantum Encryption Resilience Score for Post-Quantum Cryptography in Computer, IoT, and IIoT Systems](https://arxiv.org/abs/2601.13399)
...
- [Toward Quantum-Safe Software Engineering: A Vision for Post-Quantum Cryptography Migration](https://arxiv.org/abs/2602.05759)
- [Focus Session: LLM4PQC -- An Agentic Framework for Accurate and Efficient Synthesis of PQC Cores](https://arxiv.org/abs/2602.09919)
- [Accelerating Post-Quantum Cryptography via LLM-Driven Hardware-Software Co-Design](https://arxiv.org/abs/2602.09410)
...
- [Securing Cloud Computing Against Quantum Threats: Risk Assessment, Transition and Migration Strategies](https://arxiv.org/abs/2509.15653)
- [When Security Meets Usability: An Empirical Investigation of Post-Quantum Cryptography APIs](https://arxiv.org/abs/2602.14539)
...
- [On the Energy Cost of Post-Quantum Key Establishment in Wireless Low-Power Personal Area Networks](https://arxiv.org/abs/2602.18708)
- [Quantum Attacks Targeting Nuclear Power Plants: Threat Analysis, Defense and Mitigation Strategies](https://arxiv.org/abs/2602.21524)
- [PQC-LEO: An Evaluation Framework for Post-Quantum Cryptographic Algorithms](https://arxiv.org/abs/2603.06149)
- [Post-quantum Federated Learning: Secure And Scalable Threat Intelligence For Collaborative Cyber Defense](https://arxiv.org/abs/2603.07726)
- [LLM4PQC - Accurate and Efficient Synthesis of PQC Cores by Feedback-Driven LLMs](https://arxiv.org/abs/2602.09919)
- [Detecting Cryptographically Relevant Software Packages with Collaborative LLMs](https://arxiv.org/abs/2603.07204)
- [Layered Performance Analysis of TLS 1.3 Handshakes: Classical, Hybrid, and Pure Post-Quantum Key Exchange](https://arxiv.org/abs/2603.11006)
...
- [Evaluating PQC KEMs, Combiners, and Cascade Encryption via Adaptive IND-CPA Testing Using Deep Learning](https://arxiv.org/abs/2604.06942)
- [Post-Quantum Cryptography-Based Bidirectional Authentication Key Exchange Protocol and Industry Applications: A Case Study of Instant Messaging](https://arxiv.org/abs/2604.08612)
- [Fully Homomorphic Encryption on Llama 3 model for privacy preserving LLM inference](https://arxiv.org/abs/2604.12168)
- [Quantum-safe IPsec in the banking industry](https://arxiv.org/abs/2604.12985)
- [Quantum-Resistant Quantum Teleportation](https://arxiv.org/abs/2604.16101)
...
- [Aquaman: A Transparent Proxy Architecture for Quantum Resilient Key Establishment](https://arxiv.org/abs/2605.06932)
...
- [Operationalising Post Quantum TLS Automated Configuration Profiling and Hybrid PQC Deployment in Financial Infrastructure](https://arxiv.org/abs/2605.17955)
- [GPU Acceleration of Learning With Errors KEMs Using OpenACC for Post-Quantum Cryptography](https://arxiv.org/abs/2606.01211)
- [SoK: Post-Quantum Cryptography (PQC) Implementation in Software Systems](https://arxiv.org/abs/2606.04669)
- [Empirical Evaluation of Large Language Models for Migration of Code Fragments to Post-Quantum Cryptography](https://arxiv.org/abs/2606.07341)
- [AI-Native Closed-Loop Security for 6G-Enabled Cyber-Physical Systems: From Edge Detection to Network-Wide Mitigation](https://arxiv.org/abs/2606.08173)
- [Future-Proofing Authentication Against Insecure Bootstrapping for 5G Networks: Feasibility, Resiliency, and Accountability](https://arxiv.org/abs/2510.23457)
...
- [Pseudonym Scheme Based on Hybrid Certificates for Security Credential Management System in Vehicular Communications](https://arxiv.org/abs/2606.14008)
- [MPX: A Unified Systolic Array for Matrix and Polynomial Multiplication](https://arxiv.org/abs/2606.16394)
- [Comparative Performance Analysis of NIST PQC Standards: From STM32 Software Limitations to FPGA-SoC Acceleration](https://arxiv.org/abs/2606.15744)
- [Secure Coding Drift in LLM-Assisted Post-Quantum Cryptography Development: A Gamified Fix](https://arxiv.org/abs/2606.19474)
- [When the Learning With Errors Problem Meets the Coherent Ising Machine: A Penalty-Free Algorithm-Hardware Co-Design](https://arxiv.org/abs/2606.22843)
- [High-Performance NTT Accelerators for PQC leveraging Unified Redundant Arithmetic and Fine-Tuned Microarchitecture](https://arxiv.org/abs/2607.00621)
- [Energy-Aware System-Level Evaluation of Post-Quantum TLS on Embedded User Equipment over a Disaggregated 5G Network](https://arxiv.org/abs/2607.03988)
- [Portable Acceleration of Learning With Errors KEMs for Post-Quantum Cryptography](https://arxiv.org/abs/2607.09541)
- [A Scalable Cloud-Orchestrated and Service-Oriented Multi-Domain QKD Network with PQC Integration](https://arxiv.org/abs/2607.12765)
- [SoK: Post-Quantum Cryptography Implementation in Software: Approaches, Challenges and the PQC-HOT Framework](https://arxiv.org/abs/2606.04669)
- [On the Security Implications of PQC in TLS: Handshake Exhaustion and IDS Degradation](https://arxiv.org/abs/2607.12504)
- [HORCRUX: A Complete PQC RISC-V eXtension Architecture](https://arxiv.org/abs/2607.13939)
- [Multivariate Cryptography-Based Anonymous Certificate Scheme](https://arxiv.org/abs/2607.13554)
- [PIP-NTT: Towards a Scalable Memory-Parallelized Accelerator for Iterative NTT in PQC](https://arxiv.org/abs/2607.18533)
...
- [A Lightweight Plug-in Module for Introducing Post-Quantum Cryptography in Higher Education: An Experience Report](https://arxiv.org/abs/2410.13140)
- [Learning the Word Problem: Geodesic Lengths and Cryptographic Applications](https://arxiv.org/abs/2607.26241)
- [Mind the Gap: Policy vs Reality in Post-Quantum TLS Deployment](https://arxiv.org/abs/2607.29005)
- [NoisePQC++: A Unified NIST-Compliant PQC and Hybrid-PQC Implementation of the Noise Protocol](https://arxiv.org/abs/2608.00954)
- [Measuring Post-Quantum TLS Deployment Across UK Internet Sectors](https://arxiv.org/abs/2608.02147)
...
- [A Lightweight Fault-Detection Scheme for Barrett Modular Multiplication Using Multiple Conditional Reduction Paths](https://arxiv.org/abs/2608.10736)
- [Quantum-Safe Web Service Architecture Using Time-Based One-Time Passwords](https://arxiv.org/abs/2608.16961)
- [Secure Medical Data Transmission Using Quantum Key Distribution and Post-Quantum Cryptography in Real-World Fiber Networks](https://arxiv.org/abs/2608.18869)
...
- [A Scenario-Based Evaluation of CRQC+AI Vulnerability Spectrum for TLS 1.3 Cryptographic Dependencies](https://arxiv.org/abs/2608.23785)
- [Post-Quantum Cryptography Migration in Australian Real-Time Payment Infrastructure: A Monte Carlo Simulation Study of the New Payments Platform](https://arxiv.org/abs/2605.02276)
- [Quantum-Based Solutions for Security Enhancement in Open Radio Access Networks](https://arxiv.org/abs/2608.28480)
- [Towards Federated, Green, and Resilient 6G Non-Terrestrial Networks](https://arxiv.org/abs/2609.05184)
- [SoK: Secure Software-Based Multi-Domain Data Segregation](https://arxiv.org/abs/2609.07701)
- [Policy-Governed Post-Quantum Migration for Legacy Microservices Using Ephemeral Sidecar Architectures](https://arxiv.org/abs/2609.14286)
...
- [Design-Space Exploration of Post-Quantum Cryptography Acceleration on an Open-Source RISC-V GPGPU](https://arxiv.org/abs/2609.22343)
